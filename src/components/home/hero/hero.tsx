...
export default function Hero() {
  return (
    <div className="min-h-screen bg-[#FFD700] flex items-center">
      <div id="social" className="flex items-center flex-col justify-between min-h-[50dvh] -ml-14">
        ...
        <div className="mt-10">
          <h3
            className="font-opensans rotate-[270deg] font-bold text-4xl text-[#574900]"
            style={{ letterSpacing: '0.375rem' }}
          >
            FOLLOW US:{' '}
          </h3>
        </div>
