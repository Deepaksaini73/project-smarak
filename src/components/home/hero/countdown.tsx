...
const CountdownTimer: React.FC<CountdownTimerProps> = ({ targetDate, className }) => {
  ...
  return (
    <div className={cn('flex justify-center items-center space-x-4 md:space-x-6', className)}>
      ...
      <div className="text-construction-yellow text-xl md:text-3xl font-bold animate-pulse-soft">
        :
      </div>
      ...
      <div className="text-construction-yellow text-xl md:text-3xl font-bold animate-pulse-soft xsmd:block hidden">
        :
      </div>
